...
author:  'Benjamin Smith <a href="https://orcid.org/0009-0007-2206-0177" target="_blank">
  <img src="https://upload.wikimedia.org/wikipedia/commons/0/06/ORCID_iD.svg" alt="ORCID logo" width="16" style="vertical-align: text-bottom;">
</a>'
date: "`r Sys.Date()`"
...
vignette: >
  %\VignetteIndexEntry{degree-betweenness-algorithm}
...
```{r echo=FALSE, message=FALSE, warning=FALSE,fig.cap="The Zachary karate club network with the true split between members defined by node colors. John A. and Mr. Hi are denoted by 'J' and 'H', with other members being listed as numbers"}
set.seed(5250)
library(igraph)
library(igraphdata)
# Homemade Code
...
```{r,echo=FALSE, message=FALSE, warning=FALSE,fig.cap="Unsupervised Community Detection by (a) Girvan-Newman, (b) Louvain and (c) Smith-Pittman for the karate network."}
gn_karate <- karate |>
...
```{r,echo=FALSE, message=FALSE,fig.cap="Friendship Netowork of UK university faculty. From Nepusz et al (2008). Colored according to school affiliation."}
data("UKfaculty")
...
```{r echo=FALSE, message=FALSE, warning=FALSE,fig.cap="Unsupervised Community Detection by (a) Girvan-Newman, (b) Louvain and (c) Smith-Pittman"}
...
```{r echo=FALSE,fig.cap="A Watts-Strogatz small-world network with a 1 dimensional lattice, 100 nodes, with each node having initally  5 nearest neighbours with a 10% rewiring probability"}
...
```{r echo=FALSE,fig.cap="Unsupervised Community Detection by (a) Girvan-Newman, (b) Louvain and (c) Smith-Pittman"}
par(mfrow=c(1,3),mar=c(0,0,0,0)+1)
plot(
  gn_sim,
  sim,
...
```{r,echo=FALSE,fig.cap="Dedrogram results from unspecified Girvan-Newman on the karate dataset."}
par(mar=c(0,0,0,0)+.1)
...
```{r echo=FALSE, fig.cap= "Community division and sizes for the karate dataset by the Girvan-Newman, Louvain and Smith-Pittman algorithms."}
...
```{r echo=FALSE, fig.cap= "Community division and sizes for the UK university faculty friendship network data by the Girvan-Newman, Louvain and Smith-Pittman algorithms."}
...
```{r echo=FALSE, fig.cap= "Community division and sizes for the Watts-Strogatz simulated data by the Girvan-Newman, Louvain and Smith-Pittman algorithms."}
