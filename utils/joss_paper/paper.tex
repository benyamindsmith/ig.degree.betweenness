...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{set.seed}\NormalTok{(}\DecValTok{5250}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Homemade Code}
\CommentTok{\# devtools::install\_github("benyamindsmith/ig.degree.betweeeness")}
\FunctionTok{library}\NormalTok{(ig.degree.betweeness)}
...
\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-latex/unnamed-chunk-1-1.pdf}}
